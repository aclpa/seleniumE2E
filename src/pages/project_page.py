...
class ProjectPage(BasePage):
    ...
    project_team = (
        By.XPATH,
        "//div[contains(@class, 'q-field__control') and .//div[contains(., 'Team *')]]",
    )  # 프로젝트 팀 선택 필드
    project_team_select = (By.XPATH, "//div[@role='option']")  # 프로젝트 팀 선택 옵션
    BTN_CREATE_PROJECT_SUBMIT = (
        By.XPATH,
    ...
    def create_project(self, project_name, project_key, team_name=None):
        ...
        try:
            ...
            self.wait.until(
                EC.visibility_of_element_located(self.project_team_select)
            )  # 옵션창이 뜰 때까지 대기
            ...
            if project_name:
                ...
                specific_option_xpath = (
                    f"//div[@role='option'][contains(., '{team_name}')]"
                )
                ...
                try:
                    ...
                    print(
                        f"⚠️ '{team_name}' 옵션을 찾지 못했습니다. 첫 번째 옵션을 대신 선택합니다."
                    )
